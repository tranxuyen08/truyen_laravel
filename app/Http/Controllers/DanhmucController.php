...
class DanhmucController extends Controller
{
    ...
    public function index()
    {
        ...
        // return 'Liệt kê danh mục truyện';
    ...
    {
        // return 'Form tạo danh mục truyện';
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate(
            ...
            [
                'tendanhmuc.unique' => 'Tên danh mục đã có, hãy thử lại tên khác',
                'slug_danhmuc.unique' => 'Slug danh mục đã có, hãy thử lại slug  khác',
